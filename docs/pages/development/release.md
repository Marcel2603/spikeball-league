...
If you need to get a release, simply create an [Issue](https://github.com/Marcel2603/spikeball-league/issues) or
...
| Type             | Arc                                      | Link                                                                     |
|------------------|------------------------------------------|--------------------------------------------------------------------------|
| Docker Container | arm64 and amd64 for linux                | <https://github.com/Marcel2603/spikeball-league/pkgs/container/spikeball-league%2Fspikeball-league> |
| Executable       | arm64 and amd64 for linux/darwin/windows | <https://github.com/Marcel2603/spikeball-league/releases>                         |
